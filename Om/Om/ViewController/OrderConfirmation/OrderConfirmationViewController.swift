...
class OrderConfirmationViewController: UIViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        self.poojaInfo = [["Pooja Details" : ["Pooja Name" : UserSession.sharedInstance.selectedPooja!.name, "Panditji Name" : "\(UserSession.sharedInstance.selectedVendor!.first_name!) \(UserSession.sharedInstance.selectedVendor!.last_name!)", "Date Selected" : "03- March - 2016"]], ["Amount Details" : ["Dhanteras Pooja" : "Rs. 3100"]], ["Address Details" : ["Please edit your profile to update your address"]], ["Saamagri (Included in the pooja cost and delivered to your place)" : ["Raksha (Red/ Yellow/ Orange thread", "Roree", "Sindur", "Haldi", "Abeer", "Gulal", "Chandan Wood"]]]
